...
public class MoonSpawningMiddle : MonoBehaviour
{
    ...
    public GameObject MiddleMoonsParent;
    public int moonGoldChance = 20;
    ...
    List<Vector3> GenerateQuadrantSpawnPoints(string quadrant)
    {
        ...
        for (int i = 0; i < 12; i++)
        {
            ...
            float distance = Random.Range(12.0f, 15.0f); // Ensure moons spawn within 12-15 units of the center sun(change as needed)
    ...
    void SpawnMoons()
    {
        ...
        foreach (var quadrant in avaliableSpawnPoints.Keys)
        {
            ...
            for (int i = 0; i < moonCount; i++)
            {
                ...
                Instantiate(moonToSpawn, spawnPosition, Quaternion.identity, MiddleMoonsParent.transform);
            }
        }
    }
