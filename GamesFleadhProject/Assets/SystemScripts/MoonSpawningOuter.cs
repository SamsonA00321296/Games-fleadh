...
public class MoonSpawningOuter : MonoBehaviour
{
    ...
    public GameObject outerMoonsParent;

    public int moonGoldChance = 10;
    ...
    List<Vector3> GenerateQuadrantSpawnPoints(string quadrant)
    {
        ...
        for (int i = 0; i < 12; i++)
        {
            ...
            float distance = Random.Range(18.0f, 21.0f); // Ensure moons spawn within 18-21 units of the center sun(change as needed)
    ...
    void SpawnMoons()
    {
        ...
        foreach (var quadrant in avaliableSpawnPoints.Keys)
        {
            ...
            for (int i = 0; i < moonCount; i++)
            {
                ...
                Instantiate(moonToSpawn, spawnPosition, Quaternion.identity, outerMoonsParent.transform);
            }
        }
    }
