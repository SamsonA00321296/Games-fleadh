...
public class homePlent2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Math.PI needed on this one as it needs to invert angle 180 degrees
        float angle = Time.time * orbitalRotationalSpeed + Mathf.PI;
